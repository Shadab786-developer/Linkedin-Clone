...
function LoginNav() {
  return (
    <div className="p-0">
      ...
      <nav className="max-w-[1128px] m-auto p-[12px 0 16px] flex items-center relative justify-between flex-nowrap mt-2.5 sm:mt-3.5">
        {/* Logo */}
        <a href="#" className="w-[135px] h-[34px] sm: p-[0 5px]">
          <img src="/public/assets/images/login-logo.svg" alt="linkedin-logo" />
        </a>
        {/* Navigation links */}
